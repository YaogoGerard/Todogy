...
<template>
  <div class="stage">
    <h1 class="text-center">Nouveau départ</h1>
    <div class="sub text-center">Créez votre compte pour sauvegarder vos tâches.</div>

    <form class="card3d" style="padding: 24px" @submit.prevent="handleSubmit">
      <div class="form-group">
        <label class="form-label" for="name">Nom</label>
        <input id="name" v-model="name" type="text" class="form-input" placeholder="Jean Dupont" required />
      </div>

      <div class="form-group">
        <label class="form-label" for="email">Email</label>
        <input id="email" v-model="email" type="email" class="form-input" placeholder="exemple@email.com" required />
      </div>
      ...
      <div class="form-group">
        ...
        <div class="pw-wrapper">
          ...
          <button type="button" class="pw-toggle" @click="showPassword = !showPassword" :aria-label="showPassword ? 'Masquer' : 'Afficher'">
      ...
      <div class="form-group">
        ...
        <div class="pw-wrapper">
          ...
          <button type="button" class="pw-toggle" @click="showConfirmPassword = !showConfirmPassword" :aria-label="showConfirmPassword ? 'Masquer' : 'Afficher'">
      ...
      <button type="submit" class="form-btn" :disabled="auth.loading">Créer mon compte</button>

      <div class="form-link">
        Déjà un compte ? <router-link to="/signin">Connectez-vous</router-link>
      </div>
    </form>
